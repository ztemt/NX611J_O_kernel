...
static const struct hw_rf_band_gpio_map_str hw_rf_band_gpio_map[] = {
	{NUBIA_GPIO_PULL_DOWN, NUBIA_GPIO_PULL_DOWN,	"EURASIA_NO_NFC"},
	{NUBIA_GPIO_PULL_DOWN, NUBIA_GPIO_PULL_UP,      "EURASIA_NFC"},
	{NUBIA_GPIO_PULL_UP,   NUBIA_GPIO_PULL_DOWN,    "CHINA_NO_NFC"},
	{NUBIA_GPIO_PULL_UP,   NUBIA_GPIO_PULL_UP,      "COMMON"},
};
