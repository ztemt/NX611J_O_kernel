...
struct proc_dir_entry *himax_proc_guest_info_file 	= NULL;
...
struct proc_dir_entry *nubia_proc_ic_detect_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_IC_VER
#define NUBIA_PROC_IC_VER_FILE	"ic_ver"
struct proc_dir_entry *nubia_proc_ic_ver_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_SMART_WAKEUP
#define NUBIA_PROC_SMART_WAKEUP_FILE	"smart_wakeup"
struct proc_dir_entry *nubia_proc_smart_wakeup_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_PALM
#define NUBIA_PROC_PALM_FILE	"palm"
struct proc_dir_entry *nubia_proc_palm_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_DC_DATA
#define NUBIA_DC_DATA_FILE	"DC_data"
struct proc_dir_entry *nubia_DC_data_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_IIR_DATA
#define NUBIA_IIR_DATA_FILE	"IIR_data"
struct proc_dir_entry *nubia_IIR_data_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_BASEDC_DATA
#define NUBIA_BASEDC_DATA_FILE	"BASEDC_data"
struct proc_dir_entry *nubia_BASEDC_data_file = NULL;
#endif

#ifdef NUBIA_TP_HIMAX_PROC_USER_UPDATE
#define NUBIA_USER_UPDATE_FILE	"user_update"
